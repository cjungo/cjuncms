...
func newCjEmployeePermission(db *gorm.DB, opts ...gen.DOOption) cjEmployeePermission {
	...
	_cjEmployeePermission.ID = field.NewUint32(tableName, "id")
	_cjEmployeePermission.EmployeeID = field.NewUint32(tableName, "employee_id")
	_cjEmployeePermission.PermissionID = field.NewUint32(tableName, "permission_id")
	_cjEmployeePermission.CreateAt = field.NewTime(tableName, "create_at")
...
type cjEmployeePermission struct {
	...
	PermissionID field.Uint32 // 权限ID
	CreateAt     field.Time
...
func (c *cjEmployeePermission) updateTableName(table string) *cjEmployeePermission {
	...
	c.PermissionID = field.NewUint32(table, "permission_id")
