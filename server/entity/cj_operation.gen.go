...
func newCjOperation(db *gorm.DB, opts ...gen.DOOption) cjOperation {
	...
	_cjOperation.ID = field.NewUint32(tableName, "id")
	_cjOperation.OperatorID = field.NewUint32(tableName, "operator_id")
	_cjOperation.OperatorType = field.NewUint32(tableName, "operator_type")
	_cjOperation.OperateAt = field.NewTime(tableName, "operate_at")
	_cjOperation.OperateType = field.NewUint32(tableName, "operate_type")
...
type cjOperation struct {
	...
	ALL          field.Asterisk
	ID           field.Uint32
	OperatorID   field.Uint32 // 操作者 ID
	OperatorType field.Uint32 // 操作者类型
	...
	/*
		...
		4.查
	*/
	OperateType    field.Uint32
	OperateSummary field.String // 操作概要
...
func (c *cjOperation) updateTableName(table string) *cjOperation {
	...
	c.OperatorType = field.NewUint32(table, "operator_type")
...
func (c *cjOperation) fillFieldMap() {
	...
	c.fieldMap["operator_type"] = c.OperatorType
